...
from app.services.review_retention_service import _aware, prompt_sort_key, review_kind
...
class ReviewPromptService:
    ...
    def candidates(
        ...
        return sorted(
            found, key=lambda c: prompt_sort_key(c.kind, c.state.review.due_at, c.name, c.concept_id)
        )
